	...
	*/
	public DrawManager() {
		...
		try {
			...
			// Turtle
			spriteMap.put(SpriteType.BossB1, new boolean[150][180]);
			spriteMap.put(SpriteType.BossB2, new boolean[150][180]);
			spriteMap.put(SpriteType.BossB3, new boolean[150][180]);
